...
flname = sys.argv[1]
path = os.path.abspath(os.path.join("./temp/", flname))
bitrate = sys.argv[2]
...
def show(
    ...
    if num_windows is None:
        ...
        nperseg = int(round(track.duration_seconds /
                      num_windows * track.frame_rate))
...
show(filename=path,  num_frequencies=44100, channel=1,
     outfile=os.path.abspath(os.path.join("temp/", imgname)))
